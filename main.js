...
// EVENT: Eliminar Selected Category
...
function render() {
    ...
    if (!selectedCategoryId || selectedCategoryId === 'null') {
        currentlyViewing.innerHTML = `Actualmente estás viendo <strong>Todas las Categorías</strong>`;
    } else {
        const currentCategory = categories.find((category) => category._id === selectedCategoryId);
        currentlyViewing.innerHTML = `Actualmente estás viendo <strong>${currentCategory.category}</strong> <span>(eliminar)</span>`;
    }
}

function renderCategories() {
    categoriesContainer.innerHTML += `<li class="sidebar-item ${selectedCategoryId === 'null' || selectedCategoryId === null ? 'active' : ''}" data-category-id="">Ver Todas las Categorías</li>
	`;
...
function renderFormOptions() {
    ...
    newTodoSelect.innerHTML += `<option value="">Selecciona una Categoría</option>`;
    editTodoSelect.innerHTML += `<option value="">Selecciona una Categoría</option>`;
